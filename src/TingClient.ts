...
export class TingClient extends EventEmitter.EventEmitter2
{
    ...
    public publishFile(topicName: string, file: File): Promise<Message>
    {
        return MessagesService.publishFile(this.session, topicName, file);
    }

    public getFileDownloadURL(fileMeatdata: FileMetadata): string
    {
